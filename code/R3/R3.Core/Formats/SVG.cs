namespace R3.Core
{
	...
	public class SVG
	{
		...
		public static void WriteSegments( string file, List<Segment> segs )
		{
			XDocument xDocument =
				new XDocument( new XElement( "svg",
					new XAttribute( "width", @"5in" ),
		...
		private static XElement XSegment( Segment seg )
		{
			Polygon poly = new Polygon();
			poly.Segments.Add( seg );
			return XPolygon( poly );
		}
