namespace R3.Geometry
{
	...
	public static class Geometry2D
	{
		...
		//public static double EuclideanHypotenuse = 1.0 / Math.Sqrt( 2 );	// 4,4,4
		public static double EuclideanHypotenuse = 1.0 / 2;				// 3,6,3
		...
		public static double GetTrianglePSide( int p, int q )
		{
			...
			double alpha = Math.PI / 2;
			double beta = PiOverNSafe( q );
			double gamma = PiOverNSafe( p );	// The one we want.
			if( g == Geometry.Euclidean )
